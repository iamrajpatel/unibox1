...
! function(t, e, i, s) {
    ...
    function a(i, s) {
        this.element = i, this.elementWidth = 0, this._name = n, this.item = null, this.delta = 1, this.isAnimating = !1, this.isDragging = !1, this.timer = 0, this._timeoutId1 = 0, this._timeoutId2 = 0, this.resizeTimer = 0, this._dotControllerTimeId = 0, this._lastViewPort = 0, this.viewPort = null, this.responsiveRefreshRate = 200, this.itemWidth = 0, this._clones = 0, this._items = 0, this.windowWidth = t(e).width(), this._itemCoordinate = [], this.coordinate = {
            x: 0,
            y: 0
        }, this.prevCoordinate = {
            x: 0,
    ...
    t.extend(a.prototype, {
        ...
        cloneItems: function() {
            for (var t = [], e = [], i = this.animationType("fadeIn") ? {
                    opacity: 1
                } : {}, s = 0; s < this._clones; s++) s < this.options.items && this.$element.find(".sppb-carousel-extended-item:nth-child(" + (s + 1) + ")").addClass("active").css(i), t.push(this.$element.find(".sppb-carousel-extended-item:nth-child(" + (this._numberOfItems - s) + ")").clone(!0).addClass("clone").removeClass("active")), e.push(this.$element.find(".sppb-carousel-extended-item:nth-child(" + (s + 1) + ")").clone(!0).addClass("clone").removeClass("active"));
        ...
        createOuterStage: function() {
            this.sliderList = i.createElement("div"), this.sliderList.setAttribute("class", "sppb-carousel-extended-list"), this.outerStage = i.createElement("div"), this.outerStage.setAttribute("class", "sppb-carousel-extended-outer-stage"), this.outerStage.innerHTML = this.$element.html(), !0 === this.options.center && this.$element.addClass("sppb-carousel-extended-center"), this.animationType("fadeIn") && this.$element.addClass("sppb-carousel-fadeIn"), this.animationType("fadeOut") && this.$element.addClass("sppb-carousel-fadeOut"), this.sliderList.append(this.outerStage), this.$element.html(this.sliderList), this.$outerStage = t(this.outerStage), this.$sliderList = t(this.sliderList)
        },
        ...
        applyBasicStyle: function() {
            var e = 0,
                i = {};
            if (i.width = this.itemWidth - this.options.margin + "px", this.options.margin > 0 && (i.marginRight = this.options.margin + "px"), this.animationType("fadeIn") && (i.transition = "opacity " + this.options.speed + "ms"), this.$element.find(".sppb-carousel-extended-item").each(function() {
                    e++, t(this).css(i)
        ...
        bindEvents: function() {
            ...
            i.options.nav && (i.$nextBtn.on("click." + i._name, function(t) {
                ...
                t(this).on("click." + i._name, function(s) {
                    ...
                    i.slideFromPosition(e, a), i.updateDotsFromPosition(e + 1), i.checkCallBackMethod.call(i)
                })
            ...
            if (!1 !== e.isDragging) {
                ...
                if (e.prevCoordinate.x !== i.x) {
                    ...
                    e.prevCoordinate = {
                        ...
                        diff: n,
                        dragPointer: a
                    }, n > 0 && e.dragoverActionToNextItem(a), n < 0 && e.dragoverActionToPrevItem(a)
                }
                t.preventDefault()
            }
        },
    ...
    t(document).on("ready", function() {
        t(".sppb-carousel-extended").each(function() {
            ...
            var r = e.data("speed"),
                ...
                u = e.data("fade"),
                v = "slide";
            "layout3" !== i && "layout4" !== i || (p = !0), "layout3" === i && (s = 1, n = 1, a = 1), p && (l = e.data("padding"), c = e.data("padding-sm"), m = e.data("padding-xs")), "layout1" === i && (s = 1, n = 1, a = 1, l = 0, d = 0, u && (v = "fadeIn"));
            var f = e.data("height"),
                g = e.data("height-sm"),
                x = e.data("height-xs"),
                _ = e.data("testi-layout"),
                b = e.data("team-layout");
            (_ && !i || b) && (f = "auto", g = "auto", x = "auto");
            var y = e.data("arrow");
            y = 1 === y;
            var w = e.data("dots");
            w = 1 === w;
                ...
                null !== i && t(i).each(function() {
                    t(this).find(".sppb-carousel-extended").each(function() {
                        ...
                        var m = 180,
                            u = 90,
                            v = 50;
                        p && (m = e.data("padding"), u = e.data("padding-sm"), v = e.data("padding-xs")), "layout3" === i && (s = 1, n = 1, a = 1), "layout1" === i && (s = 1, n = 1, a = 1, m = 0, d = 0, l && (c = "fadeIn"));
                        var f = e.data("height"),
                            g = e.data("height-sm"),
                            x = e.data("height-xs"),
                            _ = e.data("testi-layout"),
